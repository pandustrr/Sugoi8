...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-light flex flex-col justify-center relative overflow-hidden selection:bg-primary/30">
            ...
            <Container className="relative z-10 flex items-center justify-center min-h-screen py-10">
                <div className="w-full max-w-md bg-white p-10 md:p-12 rounded-[40px] shadow-2xl shadow-primary/10 border border-white relative overflow-hidden">
                    {/* Inner Decorative Blur */}
                    <div className="absolute -top-20 -right-20 w-40 h-40 bg-secondary/10 rounded-full blur-[50px] pointer-events-none" />

                    {/* Logo Section */}
                    <div className="text-center mb-10 relative z-10">
                        <div className="inline-flex flex-col items-center">
                            <img src="/logo-hitam.png" alt="Sugoi 8 Logo" className="h-10 mb-6 object-contain" />
                            <h1 className="text-2xl font-black text-dark tracking-tighter uppercase mb-2">Admin Portal</h1>
                            <p className="text-dark/40 font-medium text-sm">Masuk untuk mengelola sistem.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-4 py-4 bg-light/50 border-none rounded-2xl text-dark font-medium placeholder:text-dark/20 focus:bg-light focus:ring-2 focus:ring-primary/20 transition-all outline-none"
                                    placeholder="admin"
                                    required
                                />
                            </div>
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="block w-full pl-12 pr-12 py-4 bg-light/50 border-none rounded-2xl text-dark font-medium placeholder:text-dark/20 focus:bg-light focus:ring-2 focus:ring-primary/20 transition-all outline-none"
                                    placeholder="••••••••"
                                    required
                                />
                                <button
                        ...
                        <Button
                            type="submit"
                            variant="primary"
                            className="w-full h-16 rounded-2xl gap-3 text-xs shadow-xl shadow-primary/20"
                            disabled={processing}
                        >
                    ...
                    <div className="text-center mt-10 relative z-10 pt-6 border-t border-dark/5">
                        <p className="text-dark/20 font-bold text-[9px] uppercase tracking-[0.2em]">
